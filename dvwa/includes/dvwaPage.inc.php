...
function &dvwaPageNewGrab() {
	$returnArray = array(
		'title'           => 'ZyberLab Vulnerable Web Application (VWA) v' . dvwaVersionGet() . '',
		'title_separator' => ' :: ',
		'body'            => '',
		'page_id'         => '',
		'help_button'     => '',
	...
	<body class=\"home\">
		<div id=\"container\">
			...
			<div id=\"footer\">
				...
				<p>ZyberLab Vulnerable Web Application (VWA) v" . dvwaVersionGet() . "</p>
...
function dvwaButtonHelpHtmlGet( $pId ) {
	...
	$pogi = isset($_GET['pogi']) ? $_GET['pogi'] : '';
	return "<input type=\"button\" value=\"View Help\" class=\"popup_button\" id='help_button' data-help-url='" . DVWA_WEB_PAGE_TO_ROOT . "vulnerabilities/view_help.php?id={$pId}&security={$security}&pogi={$pogi}' )\">";
}
...
function dvwaButtonSourceHtmlGet( $pId ) {
	$security = dvwaSecurityLevelGet();
	$pogi = isset($_GET['pogi']) ? $_GET['pogi'] : '';
	return "<input type=\"button\" value=\"View Source\" class=\"popup_button\" id='source_button' data-source-url='" . DVWA_WEB_PAGE_TO_ROOT . "vulnerabilities/view_source.php?id={$pId}&security={$security}&pogi={$pogi}' )\">";
}
